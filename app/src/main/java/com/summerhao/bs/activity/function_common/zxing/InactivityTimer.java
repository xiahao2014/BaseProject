...
final class InactivityTimer {
	...
	synchronized void onActivity() {
		cancel();
		inactivityTask = new InactivityAsyncTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
		//com.tentinet.shengmaoyuan.zxing.common.Runnable.execAsync(inactivityTask);
	}
